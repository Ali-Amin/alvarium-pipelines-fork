...
def call(List<String> annotatorKinds, String artifactName, Map<String,String> optionalParameters=[:], byte[] newData) {
    ...
    sdk.mutate(ctx, artifactName.getBytes(), artifactName.getBytes())
    sdk.close()
}
